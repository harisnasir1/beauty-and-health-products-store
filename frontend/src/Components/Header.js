...
const Header = () => {
  ...
  return (
    <div className='w-full z-20 text-black  bg-custom-white   pb-5 md:pb-0  h-[8vh] flex justify-between  mr-3 relative'>
      <div className='h-full text-black font-sans font-bold text-center mt-2  ml-3 md:ml-6 lg:ml-10  text-2xl md:text-3xl flex items-center gap-4 lg:text-5xl'><Link to='/'>GlowPharma</Link></div>
      <div className='w-[40vw] h-full hidden md:flex items-center justify-end gap-9 font-sans font-bold text-xl pr-20'>
        ...
        <Link className='  hover:border-b ease-in-out duration-200' to='/'>About</Link>
        <Link className='  hover:border-b ease-in-out duration-200' to='/Allproducts'>Allproducts</Link>
        <Link className='  hover:border-b ease-in-out duration-200' to='/'>Account</Link>
        <Link className='  hover:border-b-3 ease-in-out duration-200' to='/Cart'>Cart ({cartpoducts.length})</Link>
      </div>
